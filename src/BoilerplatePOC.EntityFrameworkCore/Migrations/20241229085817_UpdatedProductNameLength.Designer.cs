...
namespace BoilerplatePOC.Migrations
{
    ...
    [Migration("20241229085817_UpdatedProductNameLength")]
    partial class UpdatedProductNameLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoilerplatePOC.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("BoilerplatePOC.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("BoilerplatePOC.Authorization.Users.User", null)
                        .WithMany("Claims")
